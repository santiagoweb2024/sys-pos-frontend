...
export default function ProductToolbar() {
  return (
    <div className="p-4 bg-surface-50 dark:bg-surface-800 border-surface-200 dark:border-surface-700 shadow-sm sticky top-[68px] z-50 backdrop-blur-sm h-[130px]">
      {/* Encabezado */}
